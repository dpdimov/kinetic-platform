...
/** Record shape used when writing assessment results (fields optional for insert). */
...
/** Record shape returned when reading assessment results (fields required after select). */
...
/** Filter options for querying results (used by ResultsService). */
...
// ---------------------------------------------------------------------------
// DatabaseService — write-focused operations (from assessment)
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// ResultsService — read-focused operations with filtering (from dashboard)
// ---------------------------------------------------------------------------
